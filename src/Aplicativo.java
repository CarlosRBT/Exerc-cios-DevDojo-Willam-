...
public class Aplicativo {
    public static void main(String[] args) {
        ...
        System.out.println("1|GM        \t2|Hyundai  \t3|Volkswagen \t4|Audi \t5|Mercedes \t6|Peugeot \t|\n" +
                "|-----------\t|----------\t|------------\t|------\t|----------\t|---------\t|\n" +
        ...
        {
            System.out.println("\n\nDigite 1 para voltar ao menu e 2 para encerra o aplicativo");
            ...
            switch (menu) {
                ...
                case 2:
                    break;
                default:
                    System.out.println("Opção inválida, tente mais uma vez.");
                    return;
